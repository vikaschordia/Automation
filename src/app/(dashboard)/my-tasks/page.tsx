...
import { ListChecks, Clock, CheckCircle2, AlarmClockOff, Flame, Activity } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        ...
        <StatCard label="Urgent" value={stats.urgent} icon={Flame} tone="warning" />
        <StatCard label="Completion" value={`${stats.completionPercent}%`} icon={ListChecks} tone="success" />
      </div>
